<template>
  ...
  >
    ...
    <div class="top-100-title">歌单</div>
    <div class="top-100-item-box" ref="top100ItemBoxDom">
      <div class="top-100-item" v-for="(item, index) in songList" :key="index">
        <img
          class="top-100-album-img"
          @click="showSongList(item, index)"
          :src="item.albumimg"
          width="100px"
        />
...
export default {
  ...
  methods: {
    showSongList(item, index) {
      this.searchText = "【songList】" + item.songname;
